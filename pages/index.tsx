    ...
    <MainLayout>
      ...
      <div className="flex flex-col items-center justify-center gap-3 w-full bg-primary-400 h-[calc(100vh-53px)]">
        ...
        <h3 className="w-10/12 text-center">
          با ثبت‌نـام در تپســی دارو، به میلیون‌هــا کاربر دسترسی پیدا کنید و به
          جمع داروخانه‌های ما بپیوندید.
        </h3>
      ...
      <div className="bg-[#1E1E1E] py-6 px-4 text-white font-light">
        ...
        <p className="py-5 text-sm text-justify">
          تپسی دکتر، پلتفرم تهیه سریع و آسان داروهای مورد نیاز است. با استفاده
          از خدمات ما، داروهای خود را از نزدیک ترین داروخانه به سرعت و با
          اطمینان درب منزل دریافت کنید. تیم پشتیبانی ما همواره آماده پاسخگویی به
          سوالات و رفع نیازهای شماست.
        </p>
