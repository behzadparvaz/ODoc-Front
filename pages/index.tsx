  ...
  return (
    <>
      ...
      {showLayout ? (
        ...
        >
          <div className="flex flex-col items-center justify-center gap-3 w-full bg-primary-100 h-[calc(100vh-53px)]">
            <h1 className="text-[24px] font-semibold">
              تپسی دارو پلتفرم ارسال دارو
            </h1>
            <h3 className="font-semibold">
              در سریع‌تـرین زمان داروهاتـو دریافت کـن
            </h3>
          ...
          <div className="flex flex-col items-center justify-center gap-3 w-full bg-primary-400 h-[calc(100vh-53px)]">
            ...
            <h3 className="w-10/12 text-center">
              با ثبت‌نـام در تپســی دارو، به میلیون‌هــا کاربر دسترسی پیدا کنید
              و به جمع داروخانه‌های ما بپیوندید.
            </h3>
          ...
          <div className="bg-[#1E1E1E] py-6 px-4 text-white font-light">
            ...
            <p className="py-5 text-sm text-justify">
              تپسی دکتر، پلتفرم تهیه سریع و آسان داروهای مورد نیاز است. با
              استفاده از خدمات ما، داروهای خود را از نزدیک ترین داروخانه به سرعت
              و با اطمینان درب منزل دریافت کنید. تیم پشتیبانی ما همواره آماده
              پاسخگویی به سوالات و رفع نیازهای شماست.
            </p>

            <div className="flex flex-col gap-2 text-xs">
              <p className="w-full">
                آدرس: تهران، خیابان خالد استامبولی (وزرا)، کوچه یکم، پلاک ۴
              </p>
