...
import {
  addProductToBasket, AddProductToBasketPayload,
  deleteCurrentBasket,
  deleteProductBasket,
  getCurrentBasket, OneOfCodes,
...
export const useUpdateCountProductBasket: (
  options?: UseMutationOptions<unknown, unknown, UpdateCountProductBasketPayload>,
) => UseMutationResult<unknown, unknown, UpdateCountProductBasketPayload> = ( options) =>
  useMutation({
...
) => UseMutationResult<unknown, unknown, AddProductToBasketPayload> = ( options) =>
  useMutation({
