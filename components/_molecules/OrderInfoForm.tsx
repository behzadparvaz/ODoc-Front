  ...
  return (
    <form onSubmit={formik.handleSubmit} className="w-full">
      ...
      <Input
        ...
        onChange={formik.handleChange}
      />
      <label className="font-semibold text-sm text-gray-800 block mt-1 mb-4">{orderText?.insuranceType}</label>
      {insurances?.map(item =>
      ...
      <Footer>
        <Button className="w-full mt-6" type="submit" buttonType="contained" size="large" variant="primary">
