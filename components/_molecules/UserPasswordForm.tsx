            ...
            {data ?
                <form onSubmit={formik.handleSubmit} className="flex gap-y-7 flex-col mb-[86px]">
                    <Input
                        ...
                        isTouched={formik.touched.Password && Boolean(formik.errors.Password)}
                    ...
                    <Input
                        ...
                        onChange={formik.handleChange}
                        isTouched={formik.touched.ConfrimPassword && Boolean(formik.errors.ConfrimPassword)}
                        errorMessage={formik.errors.ConfrimPassword}
                    />
                    <Button type="submit" className='w-full mt-3' size='large' buttonType='contained' variant={'primary'}>{generalTexts?.confirm}</Button>
                </form>
                : <div className="pt-36 text-center text-md text-red-600">برای ثبت پسورد ابتدا اطلاعات کاربری خود را تکمیل کنید!</div>
            }
        </>
    )
}
